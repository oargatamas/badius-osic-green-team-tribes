    ...
    public void confirm(Production transaction) {
        if (transaction.getState().equals(TransactionState.COMPLETED)) {
            ...
            switch (transaction.getProductionType()) {
                case GOLD: transaction.getTargetKingdom().getStorage().setGold(transaction.getTargetKingdom().getStorage().getGold() + transaction.getQuantity());
                    break;
                case FOOD: transaction.getTargetKingdom().getStorage().setFood(transaction.getTargetKingdom().getStorage().getFood() + transaction.getQuantity());
                    break;
                ...
                case UNIT: // do we actually produce plain unit?
                    break;
                case TOWNHALL: transaction.getTargetKingdom().addBuilding(BuildingType.TOWNHALL, transaction.getQuantity());
                    break;
                case MINE: transaction.getTargetKingdom().addBuilding(BuildingType.MINE, transaction.getQuantity());
                    break;
                case FARM: transaction.getTargetKingdom().addBuilding(BuildingType.FARM, transaction.getQuantity());
                    break;
                case BARRACK: transaction.getTargetKingdom().addBuilding(BuildingType.BARRACK, transaction.getQuantity());
                    break;
                case ACADEMY: transaction.getTargetKingdom().addBuilding(BuildingType.ACADEMY, transaction.getQuantity());
                    break;
                case KNIGHT: transaction.getTargetKingdom().addTroop(UnitType.KNIGHT, transaction.getQuantity());
                    break;
                case ROGUE: transaction.getTargetKingdom().addTroop(UnitType.ROGUE, transaction.getQuantity());
                    break;
                case MAGE: transaction.getTargetKingdom().addTroop(UnitType.MAGE, transaction.getQuantity());
                    break;
                case ARCHER: transaction.getTargetKingdom().addTroop(UnitType.ARCHER, transaction.getQuantity());
                    break;
                case SQUIRE: transaction.getTargetKingdom().addTroop(UnitType.SQUIRE, transaction.getQuantity());
                    break;
                case DIPLOMAT: transaction.getTargetKingdom().addTroop(UnitType.DIPLOMAT, transaction.getQuantity());
                    break;
                default:
